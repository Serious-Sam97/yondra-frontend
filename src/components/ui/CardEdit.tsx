    ...
    return (
        ...
        >
            ...
            <div
                ...
                className="h-8 w-full rounded-t-sm flex items-center justify-between px-4"
            >
                ...
                <button
                    onClick={goBack}
                    style={{ color: '#a89800' }}
                    className="text-sm hover:opacity-60 cursor-pointer transition-opacity leading-none"
                >
                    ✕
                </button>
            </div>
