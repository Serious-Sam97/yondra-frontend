...
export function ListView({
  ...
  const thresholdFor = (card: CardInterface) =>
    agingThresholdMs(
      card.section_entered_at,
      sections.find((s) => s.id === card.section_id)?.aging_hours,
      card.done_at,
    );
  ...
  const sorted = [...cards].sort((a, b) => {
    ...
    if (sortKey === "name") {
      ...
      cmp =
        sections.findIndex((s) => s.id === a.section_id) -
        sections.findIndex((s) => s.id === b.section_id);
  ...
  return (
    <div className="flex flex-col pb-8">
      {/* Header */}
      <div
        className="grid grid-cols-[28px_1fr_auto_auto] md:grid-cols-[28px_1fr_140px_130px_110px_36px] aero-column rounded-b-none overflow-hidden"
      ...
      >
        ...
        <ColHeader
          k="section"
          label="Section"
          className="md:border-l md:border-white/15 hidden md:flex"
        />
        <div
      ...
      <div className="aero-column rounded-t-none overflow-hidden">
        ...
        {sorted.map((card) => {
          ...
          const sColor =
            SECTION_COLORS[Math.max(0, sIdx) % SECTION_COLORS.length];
            ...
            <button
              ...
              style={{
                ...
                ...(aged
                  ? {
                      background:
                        "color-mix(in srgb, var(--cf-red) 14%, transparent)",
                      boxShadow: "inset 3px 0 0 var(--cf-red)",
                    }
                  : null),
              }}
            >
              ...
              <div className="px-3 py-3 flex items-center gap-2 min-w-0 md:border-l md:border-white/10">
                ...
                {isCrm && card.value != null && card.value !== "" && (
                  <span
                    className="cf-mono text-[10px] font-bold whitespace-nowrap flex-shrink-0"
                ...
                {aged && (
                  <span
                    ...
                    style={{
                      color: "var(--cf-red)",
                      background:
                        "color-mix(in srgb, var(--cf-red) 18%, transparent)",
              ...
              <div className="px-3 py-3 hidden md:flex items-center md:border-l md:border-white/10">
                <span
                  ...
                  style={{
                    color: sColor,
                    borderColor: sColor + "88",
                    boxShadow: `0 0 8px ${sColor}55`,
                  }}
                >
                  {section?.name ?? "—"}
                </span>
