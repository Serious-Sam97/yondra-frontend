    ...
    >
      ...
      >
        ...
        >
          ...
          <kbd
            className="cf-mono hidden sm:block text-[10px] px-1.5 py-0.5 rounded flex-shrink-0"
            style={{
        ...
        >
          {results.length === 0 && (
            <p
              className="cf-label text-xs uppercase tracking-widest text-center py-10"
              style={{ color: "var(--cf-text-muted)" }}
            >
              ...
              <button
                ...
                style={{
                  ...
                  backgroundColor: isActive
                    ? "rgba(154,166,126,0.10)"
                    : "transparent",
                  boxShadow: isActive
                    ? "inset 2px 0 0 var(--cf-phosphor)"
                    : "none",
                }}
              >
                <div className="flex items-center gap-2 min-w-0">
                  ...
                  {card.priority && (
                    <div
                      ...
                      style={{
                        ...
                        boxShadow: `0 0 6px ${PRIORITY_COLOR[card.priority]}`,
                      }}
                    />
                  )}

                  <span
                    className="cf-mono text-sm font-medium truncate flex-1"
                    style={{
                      color: isActive ? "var(--cf-phosphor)" : "var(--cf-text)",
                    }}
                  >
                  ...
                  {card.due_date && (
                    <span
                      className="cf-lcd text-[10px] flex-shrink-0"
                      style={{ color: "var(--cf-text-muted)" }}
                    >
                ...
                <div className="flex items-center gap-2 pl-3.5">
                  ...
                  {card.description &&
                    ...
                    card.description.toLowerCase().includes(q) && (
                      <span
                        className="cf-mono text-[10px] truncate"
                        style={{ color: "var(--cf-text-muted)" }}
                      >
        ...
        >
          ...
          <div className="flex items-center gap-2 ml-auto">
            <kbd
              className="cf-mono text-[10px] px-1 py-0.5 rounded"
              style={{
                color: "var(--cf-text-muted)",
                border: "1px solid var(--cf-edge)",
              }}
...
function highlight(text: string, q: string): React.ReactNode {
  ...
  return (
    <>
      ...
      <mark
        style={{
          backgroundColor: "rgba(154,166,126,0.22)",
          color: "var(--cf-phosphor)",
          borderRadius: "2px",
          textShadow: "0 0 8px var(--cf-phosphor)",
        }}
      >
