...
export default function BoardChat({
  ...
  return (
    <div
      className="aero-menu w-[95vw] max-w-md flex flex-col"
    ...
    >
      ...
      <div className="flex flex-col gap-3 overflow-y-auto px-5 py-4 flex-1">
        {messages.length === 0 && (
          <p
            className="cf-mono text-xs text-center py-8"
            style={{ color: "var(--cf-text-muted)" }}
          >
        ...
        {messages.map((msg) => {
          ...
          return (
            ...
            >
              ...
              >
                <div
                  ...
                  style={{
                    ...
                    border: isOwn
                      ? "1px solid rgba(154,166,126,0.35)"
                      : "1px solid var(--cf-edge)",
                  }}
                >
                  {msg.body}
                </div>
              ...
              <span
                className="cf-mono text-xs px-1"
                style={{ color: "var(--cf-text-muted)" }}
              >
                {!isOwn && (
                  <span
