...
import { postAuthRedirectPath, register } from "@/lib/auth";
...
export default function RegisterPage() {
  ...
  const registerAction = async () => {
    ...
    try {
      ...
      setIsLogged(true);
      // Honor a safe ?next= (carried over from a 401 redirect), like the login page.
    ...
    <div className="min-h-[90vh] flex items-center justify-center px-4 py-8">
      <div className="relative z-10 w-full max-w-md">
        <div className="flex flex-col items-center mb-8">
          ...
          >
            Join Yondra and start organizing
          </p>
        </div>
        ...
        >
          ...
          <p
            className="text-center text-sm mt-5 cf-mono"
            style={{ color: "var(--cf-text-muted)" }}
          >
